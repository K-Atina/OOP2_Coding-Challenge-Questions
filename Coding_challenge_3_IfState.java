...
public class Coding_challenge_3_IfState {
    ...
    if (daysUntilExpiration<1){
        ...
        System.out.println("Your subscription is valid for:" + daysUntilExpiration + " days.");
        System.out.println("Your subscription is valid for a long time. No need to renew now!");
    }
